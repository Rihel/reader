    ...
    function G(t, e) {
        ...
        n.fn[t] = function () {
            var t,
                ...
                o = i ? u : u.parentNode, u = 0 == e ? u.nextSibling : 1 == e ? u.firstChild : 2 == e ? u : null;var f = n.contains(a.documentElement, o);
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    function v(e, i, r, o, a, u, f) {
        ...
        i.split(/\s/).forEach(function (i) {
            if ("ready" == i) return t(document).ready(r);var s = p(i);
    ...
    l.href = window.location.href, t.active = 0, t.ajaxJSONP = function (i, r) {
        ...
        S.open(o.type, o.url, N, o.username, o.password);for (r in p) {
            T.apply(S, p[r]);
